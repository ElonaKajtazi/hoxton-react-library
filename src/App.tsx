  ...
  return (
    <div className="App">
      ...
      >
        ...
        {/* <Label question={"Favorite Color:"} type={"color"} name={"color"} /> */}
        <CheckboxGroup
          question={"What's your favourtie food?"}
          name={"food"}
          options={["Chocolate", "Fruits", "Vegetables"]}
        />

        <CheckboxGroup
          question={"What's your favourtie color?"}
          name="color"
